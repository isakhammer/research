...
\begin{enumerate}[label=(\alph*)]
  \item  What are the eigenvalues of $A$ ? What would the Gershgorin theorem tell us abou the location of the eigenvalues of $A$.
    \begin{tcolorbox}
      \textbf{Answer.} 
I get the eigen values equal to $ (- \lambda )^n =0 $. Which means all the eigen values are zero. You can use the Gershgorin theorem to determine the radius of each eigenvalue.
    \end{tcolorbox}
